    ...
    <div class="content">
      <div class="container-fluid pt-5">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body" style="display:flex; justify-content: center; align-items: center;">
               ...
               <form action="procesos/reg-documento.php" method="post">
            ...
            <input type="text" name="namearch" class="form-control mb-1 mt-1" id="nameform" readonly required>
          ...
          <div class="col-lg-6">
              ...
              <p>4) Como paso final se da clic en el bot&#243;n de Registro para subir dicho documento.</p>
          </div>
              </div>
            </div>
